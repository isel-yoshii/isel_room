...
What it creates:
  - 7 lab members (1 admin + 6 students, one without a face embedding)
...
MEMBERS = [
    ...
    ('Tanaka Kenta',     '管理者', True,  True),
    ('Sato Misaki',      '学生',   True,  False),
    ('Suzuki Daiki',     '学生',   True,  True),
    ('Yamada Hanako',    '学生',   True,  True),
    ('Nakamura Takumi',  '学生',   True,  False),
    ('Kobayashi Sakura', '学生',   False, False),   # no face enrolled
    ('Ito Yuto',         '学生',   True,  False),
]
